...
export default function ExamSettings({ scoringMode, setScoringMode, typeCounts, questions = [] }) {
  return <div style={{ border: '1px solid var(--ant-color-warning-border, rgba(255,159,10,.35))', borderRadius: 8, padding: 16, background: 'var(--ant-color-warning-bg, rgba(255,159,10,.12))' }}>
    <Text strong style={{ display: 'block', marginBottom: 12 }}>分数设置</Text>
